                ...
                <tr key={t.id} style={{ cursor: 'default' }}>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                      <button onClick={() => router.push(`/tenants/${t.id}`)} style={{ padding: '6px 14px', borderRadius: 8, background: 'rgba(79,110,247,0.1)', color: '#4f6ef7', border: '1px solid rgba(79,110,247,0.2)', fontSize: 12, cursor: 'pointer', fontFamily: 'inherit', fontWeight: 600, whiteSpace: 'nowrap' }}>
                        إدارة
                      </button>
                      {t.slug !== 'default' && (
