  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24, color: 'var(--text-muted)', fontSize: 13 }}>
        <button onClick={() => router.visit('/super/tenants')} style={{ background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontFamily: 'inherit', fontSize: 13, padding: 0 }}>المستأجرون</button>
        <span>/</span>
...
TenantDetailPage.layout = (page: React.ReactNode) => <DashboardLayout children={page} />;
